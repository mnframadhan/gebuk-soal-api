...
export class AdministratorController {
    ...
    static async updateStudentCompletePackage(req: Request, res: Response, next: NextFunction) {
        try {
            const id = req.query.id as string;
            const response = await AdministratorService.updateStudentCompletePackage(id);
