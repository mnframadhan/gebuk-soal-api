...
exports.SoalController = void 0;
const soal_service_1 = require("../service/soal-service");
class SoalController {
    static createSoal(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const request = yield req.body;
                const response = yield soal_service_1.SoalService.createSoal(request, req.contributor);
                res.status(201);
                res.json(response);
            }
            catch (err) {
