...
const soal_tiu_kata_model_1 = require("../../../model/soal-cpns/soal-tiu/soal-tiu-kata-model");
const soal_tiu_validation_1 = require("../../../validation/soal-cpns/soal-tiu/soal-tiu-validation");
...
class SoalTIUKataService {
    static createSoalTIUKata(request, contributor) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, soal_tiu_kata_model_1.toSoalTIUKataResponse)(soal);
        });
    }
    static getSoalTIUKata(limit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, soal_tiu_kata_model_1.toSoalTIUKataResponsePagination)(soalTIUKata, pagination);
        });
    }
}
